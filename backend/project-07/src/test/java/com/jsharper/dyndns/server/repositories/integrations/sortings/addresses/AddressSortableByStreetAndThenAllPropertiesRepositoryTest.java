...
public class AddressSortableByStreetAndThenAllPropertiesRepositoryTest {
    @Autowired
    ...
    void createSimpleAddressEntity_whenProvidedAddressInstance_returnAddressEntity() {
        ...
        assertEquals(storedAddress.getId(), address.getId());
        assertEquals(storedAddress.getCity(), address.getCity());
        assertEquals(storedAddress.getStreet(), address.getStreet());
        assertEquals(storedAddress.getState(), address.getState());
        assertEquals(storedAddress.getZipCode(), address.getZipCode());
        assertEquals(storedAddress, address);

        ar.deleteById(storedAddress.getId());

        assertThrows(NoSuchElementException.class, ()->ar.findById(storedAddress.getId()).orElseThrow());
    }
    ...
    void findAllAddressesWithQueryAndPageableAndSortByStreet_whenProvidedListOfAddresses_returnListPageableListOfAddresses() {
        ...
        var sort = Sort.by(Sort.Direction.ASC, "street", "city");
        ...
        inputAddresses.sort(
                Comparator.comparing(Address::getStreet)
    ...
    @TestFactory
    @Order(2)
    @DisplayName("Find all Addresses with query and pageable and pageable and sort by street and then state and compare to memory list")
    Stream<DynamicTest> findAllAddressesWithQueryAndPageableAndSortByStreetAndThenStateAndComparateToMemoryList_whenProvidedListOfAddresses_returnListPageableListOfAddresses() {
        var initialPageNumber = 0;

        var initialPageSize = 4;

        var sort = Sort.by(Sort.Direction.ASC, "id", "street", "state");
        ...
        inputAddresses.sort(
                Comparator.comparing(Address::getId)
                        .thenComparing(Address::getCity)
    ...
    @TestFactory
    @Order(3)
    @DisplayName("Find all Addresses with query and pageable and pageable and sort by Street and then ZipCode and compare to memory list")
    Stream<DynamicTest> findAllAddressesWithQueryAndPageableAndSortByStreetAndThenZipCodeAndComparateToMemoryList_whenProvidedListOfAddresses_returnListPageableListOfAddresses() {
        var initialPageNumber = 0;

        var initialPageSize = 4;

        var sort = Sort.by(Sort.Direction.ASC, "id","street", "zipCode");
    ...
    @TestFactory
    @Order(4)
    @DisplayName("Find all Addresses with query and pageable and pageable and sort by id, street, city, state, zip Code and compare to memory list")
    Stream<DynamicTest> findAllAddressesWithQueryAndPageableAndSortByIdAndThenStreetAndThenCityAndThenZipCodeAndComparateToMemoryList_whenProvidedListOfAddresses_returnListPageableListOfAddresses() {
        var initialPageNumber = 0;

        var initialPageSize = 4;

        var sort = Sort.by(Sort.Direction.ASC, "id", "street", "city", "state", "zipCode");
